"""
Django settings for condominium_manager_server project.
...
SECRET_KEY = 'j!+k6b+1@#9l1)=jnzt%dxv!1a=qs_d@#gm3a0pegw2wapw_en'
...
ROOT_URLCONF = 'condominium_manager_server.urls'
